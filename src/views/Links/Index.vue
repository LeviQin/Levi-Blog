  ...
  supportList: [
    {
      ...
      describe:
        "是一款用于构建用户界面的 JavaScript 框架。它基于标准 HTML、CSS 和 JavaScript 构建，并提供了一套声明式的、组件化的编程模型...",
      icon: `data:image/png;base64,`,
    },
    {
      title: "Vite",
      describe: "是一种新型前端构建工具，能够显著提升前端开发体验。",
