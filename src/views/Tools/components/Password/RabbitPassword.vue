      ...
      <el-form-item label="结果:">
        ...
        <div class="copy-btn-card">
          <el-button
            ...
            @click="copyResult"
            class="clipboardBtn"
            data-clipboard-target="#copy-span-rabbit"
            >一键复制结果</el-button
          >
        </div>
      </el-form-item>
    ...
    <div>
      ...
      <div>
        <p class="introduction-text">
          在线Rabbit加密，Rabbit解密，可以输入密钥后进行加密和解密，支持可逆加密解密。
        </p>
        <p class="introduction-text">
          <span class="red-text">[Rabbit加/解密]</span>
...
const encrypt = () => {
  ...
  const bytes = CryptoJS.Rabbit.encrypt(textarea.value, secretKey.value);
