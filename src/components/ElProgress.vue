...
.el-progress-bar__outer { overflow: hidden; border-radius: 999px; background: rgba(34,211,238,.14); }
.el-progress-bar__inner { height: 100%; border-radius: inherit; background: linear-gradient(135deg, var(--theme-btn-hover-color,#22d3ee), #7da7d1); transition: width .3s ease; }
.is-success .el-progress-bar__inner { background: linear-gradient(135deg,#67c23a,#8ed15e); }
.is-striped .el-progress-bar__inner { background-image: linear-gradient(135deg, rgba(255,255,255,.18) 25%, transparent 25%, transparent 50%, rgba(255,255,255,.18) 50%, rgba(255,255,255,.18) 75%, transparent 75%, transparent), linear-gradient(135deg, var(--theme-btn-hover-color,#22d3ee), #7da7d1); background-size: 28px 28px, auto; }
