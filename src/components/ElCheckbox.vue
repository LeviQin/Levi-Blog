...
.el-checkbox__inner { width: 16px; height: 16px; display: block; border-radius: 4px; border: 1px solid var(--border-color); background: var(--theme-color); transition: all .2s ease; box-sizing: border-box; }
